...
if (isset($_POST['reg'])) {
    ...
    $ses->addHealthIssue($illness, $tests, $result, $nin);
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3>Register New Health Issue</h3>
                                </div>
                                <form method="post">
                                    <div class="box-body">
                                        <div class="row">
                                    ...
                                    <div class="box-footer text-right">
                                        <button type="submit" name="reg" class="btn btn-primary">Register Health Issue</button>
                                    </div>
                                </form>
                            </div>
                        </div>
